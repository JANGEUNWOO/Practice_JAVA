...
public class FrameWindowEventExample {
	...
	public static void main(String[] args) {
		...
		/*
		 * 이 프로엠의 이벤트가 발생하면 처리할 EventHandler클래스를 생성하여
		 * 리스너에 등록하고 있다. 리스너가 무엇인가? 듣는 것이다. 즉 이벤트를 감지하고 있는 것
		 */
