...
public class SeedExample {
	...
	public static void main(String[] args) {
		...
		//Math.random()과 Random클래스의 가장 큰차이점은 종자값(Seed)를
		//설정할수 있는 것에 차이가 있다.
		//Random에서 종자값을 설정하면, 항상 같은 난수를x 같은 순서대로 반환한다는 것
		...
		System.out.println("=rand1(생성 다른값 반환)=");
		...
		System.out.println("=rnad2(항상 같은 값 반환)=");
