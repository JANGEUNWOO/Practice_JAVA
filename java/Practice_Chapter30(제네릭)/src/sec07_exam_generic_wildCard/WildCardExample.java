...
public class WildCardExample {
	...
	public static void main(String[] args) {
		...
		registerCourse(new Course<HightStudent>("고등학생 과정", 5));
		System.out.println();
		...
		registerCourseStudent(new Course<HightStudent>("고등학생 과정", 5));
		System.out.println();
		...
		// registerCourseWorker(new Course<HightStudent>("고등학생 과정", 5)); //에러난다. 왜?
		System.out.println();
		...
		Course<HightStudent> HightStudentCourse = new Course<>("고등학생 과정", 5);
		HightStudentCourse.add(new HightStudent("신동호"));
		HightStudentCourse.add(new HightStudent("김기리"));
		HightStudentCourse.add(new HightStudent("신용권"));
		...
		System.out.println();
		// registerCourseStudent(personCourse); //에러난다. 왜?
		...
		// registerCourseWorker(studentCourse); //에러난다. 왜?
		// registerCourseWorker(HightStudentCourse); //에러난다. 왜?
	}
